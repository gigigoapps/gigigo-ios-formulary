...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="GIGLibrary",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
# pragma pop_macro("any")
#endif


SWIFT_CLASS("_TtC10GIGLibrary15AlertController") SWIFT_AVAILABILITY(ios,introduced=8.0)
@interface AlertController : NSObject
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end


SWIFT_CLASS("_TtC10GIGLibrary11ActionSheet") SWIFT_AVAILABILITY(ios,introduced=8.0)
...
SWIFT_CLASS("_TtC10GIGLibrary24GIGScannerViewController")
@interface GIGScannerViewController : UIViewController <AVCaptureMetadataOutputObjectsDelegate>
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)aDecoder OBJC_DESIGNATED_INITIALIZER;
- (void)viewDidLoad;
...
///   </li>
/// </ul>
SWIFT_CLASS("_TtC10GIGLibrary19ProgressPageControl") SWIFT_AVAILABILITY(ios,introduced=9.0)
...
SWIFT_CLASS("_TtC10GIGLibrary12ScreenRecord")
@interface ScreenRecord : NSObject
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_DEPRECATED_MSG("-init is unavailable");
@end
...
@interface ScreenRecord (SWIFT_EXTENSION(GIGLibrary)) <RPPreviewViewControllerDelegate>
