...
function createBooleanField(keyTextField,title,error,mandatory,cellColor,titleColor,errorColor,sizeTitle,sizeError,align,font,imageMandatory,imageCheckBoxOn,imageCheckBoxOff, isLink) {
    var valueCheck = ""
    if (mandatory) {
        valueCheck = "checked"
    }
    var isLinkValueCheck = ""
    if (isLink) {
        isLinkValueCheck = "checked"
    }
